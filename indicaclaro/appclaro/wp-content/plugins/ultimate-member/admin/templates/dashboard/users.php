<div class="table">
		...
		<table>
			...
			<tr class="first">
				...
				<td class="t"><a href="<?php echo admin_url('users.php'); ?>"><?php _e('Usuario','ultimate-member'); ?></a></td>
			</tr>
			...
			<tr>
				...
				<td class="t"><a href="<?php echo admin_url('users.php?status=approved'); ?>"><?php _e('Aprovado','ultimate-member'); ?></a></td>
			</tr>
			...
			<tr>
				...
				<td class="t"><a href="<?php echo admin_url('users.php?status=rejected'); ?>"><?php _e('Rejeitado','ultimate-member'); ?></a></td>
			</tr>
...
<div class="table table_right">
		...
		<table>
			...
			<tr class="first">
				...
				<td class="last t"><a href="<?php echo admin_url('users.php?status=awaiting_admin_review'); ?>" class="warning"><?php _e('Revisão Pendente','ultimate-member'); ?></a></td>
			</tr>
			...
			<tr>
				...
				<td class="last t"><a href="<?php echo admin_url('users.php?status=awaiting_email_confirmation'); ?>" class="warning"><?php _e('Esperando Confirmação de E-mail','ultimate-member'); ?></a></td>
			</tr>
			...
			<tr>
				...
				<td class="t"><a href="<?php echo admin_url('users.php?status=inactive'); ?>"><?php _e('Inativo','ultimate-member'); ?></a></td>
			</tr>

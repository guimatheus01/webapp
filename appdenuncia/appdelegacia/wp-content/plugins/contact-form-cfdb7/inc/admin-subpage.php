        ...
        ?>
            <div class="wrap">
                ...
                <form method="post" action="">
                    ...
                    <?php $ListTable->search_box('Pesquisar', 'search'); ?>
...
{   
    ...
    protected function bulk_actions( $which = '' ) {
        ...
        echo '<label for="bulk-action-selector-' . esc_attr( $which ) . '" class="screen-reader-text">' . __( 'Selecione a ação em massa' ) . '</label>';
        echo '<select name="action' . $two . '" id="bulk-action-selector-' . esc_attr( $which ) . "\">\n";
        echo '<option value="-1">' . __( 'Ações em Massa' ) . "</option>\n";

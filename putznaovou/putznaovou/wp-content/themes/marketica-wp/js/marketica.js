...
(function($){
    ...
    $(document).ready(function(){
        ...
        // set sidebar height same as content height
        $(window).bind("load", function() {
           // code here
            var height_content = $('.layout-2c-l .content-area').height();
            var height_woo_tabs = $('.woocommerce-tabs').height();
            var height_woo_tab_info = $('.woocommerce-tabs #tab-additional_information').height();
            var height_woo_tab_review = $('.woocommerce-tabs #tab-reviews').height();
            if( height_woo_tab_review == null ) {
                var height_final = height_content - height_woo_tab_info + height_woo_tabs;
            } else if ( height_woo_tab_info == null ) {
                var height_final = height_content - height_woo_tab_review + height_woo_tabs;
            } else {
                var height_final = height_content - height_woo_tab_review - height_woo_tab_info + height_woo_tabs;
            }
            $(".layout-2c-l .sidebar").css('min-height', height_content );
        });
        ...
        var tp_product_summary = $('.woocommerce div.product div.summary-inner');
        if ( $(window).width() < 992 ) {
            $('.woocommerce div.product div.summary').append(tp_product_summary);
            $('.woocommerce div.product div.product-calltoaction').hide();
        } 
        else {
            $('.woocommerce div.product div.product-calltoaction').append(tp_product_summary);
            $('.woocommerce div.product div.product-calltoaction').show();
        }
	    $(window).resize(function() {
	        if ( $(window).width() < 992 ) {
	            $('.woocommerce div.product div.summary').append(tp_product_summary);

 ...
 */
		...
		$defaults = array(
			'container'       => 'div',
			'container_class' => 'breadcrumb-trail breadcrumb breadcrumbs',
			'separator'       => '&#47;',
			'before'          => '',
			'after'           => '',
			'show_on_front'   => true,
 ...
 */
		if( "list" == $this->args['markup_type'] ) {
			if ( !empty( $this->items ) && is_array( $this->items ) ) {

				/* Open the breadcrumb trail containers.
	 */
				$breadcrumb = "\n\t\t" . '<' . tag_escape( $this->args['container'] ) . ' class="' . $this->args['container_class'] . '">';
	 ...
	 */
				$separator = ( !empty( $this->args['separator'] ) ? '<li class="sep">' . $this->args['separator'] . '</li>' : '<li class="sep">/</li>' );
